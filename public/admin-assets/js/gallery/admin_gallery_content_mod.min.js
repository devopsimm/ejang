...
(function () {
    ...
    tempPath = baseUrl + '/themes/admin/templates/', attemptedUploads = [], errorFlag = false, httpRequest = function (route, method, data, isDataType) {
    ...
    appendImageGallery = function (data) {
        ...
        var ele = $(this), id = ele.attr('data-id'), dataTime = ele.attr('data-datetime');
        if (ele.hasClass('singleimage')) {
            ...
            if (typeof id !== 'undefined') {
                ...
                var data = httpRequest('geonewimages/content/gallery/ajax_delete_gallery_image', 'post', postData, true);
            }
