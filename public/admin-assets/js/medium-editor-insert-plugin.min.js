...
!function (a) {
    "function" == typeof define && define.amd ? define(["jquery", "handlebars/runtime", "medium-editor", "blueimp-file-upload", "jquery-sortable"], a) : "object" == typeof module && module.exports ? module.exports = function (b) {
        if ("undefined" == typeof window)throw new Error("medium-editor-insert-plugin runs only in a browser.");
        return void 0 === b && (b = require("jquery")), window.jQuery = b, Handlebars = require("handlebars/runtime"), MediumEditor = require("medium-editor"), require("jquery-sortable"), require("blueimp-file-upload"), a(b, Handlebars, MediumEditor), b
    } : a(jQuery, Handlebars, MediumEditor)
}(function (a, b, c) {
    this.MediumInsert = this.MediumInsert || {}, this.MediumInsert.Templates = this.MediumInsert.Templates || {}, this.MediumInsert.Templates["src/js/templates/core-buttons.hbs"] = b.template({
        1: function (a, b, c, d, e) {
            var f, g, h = null != b ? b : {}, i = c.helperMissing, j = "function";
            return '            <li><button data-addon="' + a.escapeExpression((g = null != (g = c.key || e && e.key) ? g : i, typeof g === j ? g.call(h, {
                name: "key",
                hash: {},
                data: e
            }) : g)) + '" data-action="add" class="medium-insert-action" type="button">' + (null != (g = null != (g = c.label || (null != b ? b.label : b)) ? g : i, f = typeof g === j ? g.call(h, {
                name: "label",
                hash: {},
                data: e
            }) : g) ? f : "") + "</button></li>\n"
    ...
    }), this.MediumInsert.Templates["src/js/templates/core-caption.hbs"] = b.template({
        compiler: [7, ">= 4.0.0"],
        ...
        useData: !0
    }), this.MediumInsert.Templates["src/js/templates/core-empty-line.hbs"] = b.template({
        compiler: [7, ">= 4.0.0"],
        main: function (a, b, c, d, e) {
            return "<p><br></p>\n"
        },
        useData: !0
    }), this.MediumInsert.Templates["src/js/templates/embeds-toolbar.hbs"] = b.template({
        1: function (a, b, c, d, e) {
            var f;
    ...
    }), this.MediumInsert.Templates["src/js/templates/embeds-wrapper.hbs"] = b.template({
        compiler: [7, ">= 4.0.0"],
        main: function (a, b, c, d, e) {
            var f, g;
        ...
        useData: !0
    }), this.MediumInsert.Templates["src/js/templates/images-fileupload.hbs"] = b.template({
        compiler: [7, ">= 4.0.0"],
        main: function (a, b, c, d, e) {
            return '<input type="file" multiple>'
        },
        useData: !0
    }), this.MediumInsert.Templates["src/js/templates/images-image.hbs"] = b.template({
        1: function (a, b, c, d, e) {
    ...
    }), this.MediumInsert.Templates["src/js/templates/images-progressbar.hbs"] = b.template({
        compiler: [7, ">= 4.0.0"],
        main: function (a, b, c, d, e) {
            return '<progress min="0" max="100" value="0">0</progress>'
        },
        useData: !0
    }), this.MediumInsert.Templates["src/js/templates/images-toolbar.hbs"] = b.template({
        1: function (a, b, c, d, e) {
            var f;
            return null != (f = c["if"].call(null != b ? b : {}, null != b ? b.label : b, {
                name: "if",
        ...
        var g = "mediumInsert", h = {editor: null, enabled: !0, addons: {images: !0, embeds: !0}};
        f.prototype.init = function () {
            ...
            return a.each(b, function (c) {
                ...
                d.find(".medium-insert-buttons").remove(), d.find(".medium-insert-active").removeClass("medium-insert-active"), d.find("[data-embed-code]").each(function () {
                    var b = a(this), c = a("<div />").html(b.attr("data-embed-code")).text();
                    b.html(c)
                }), b[c].value = d.html()
            }), b
        }, f.prototype.editorDestroy = function () {
            a.each(this.elements, function (b, c) {
                a(c).data("plugin_" + g) instanceof f && a(c).data("plugin_" + g).disable()
            }), this._destroy()
        }, f.prototype.editorSetup = function () {
            this._setup(), a.each(this.elements, function (b, c) {
                a(c).data("plugin_" + g) instanceof f && a(c).data("plugin_" + g).enable()
            })
            ...
            return this.options.enabled !== !1 ? this.templates["src/js/templates/core-buttons.hbs"]({addons: this.options.addons}).trim() : void 0
            ...
            var d, e, f, g, h = a(c.target), i = b.getSelection(), j = this;
            ...
            }), f.length && ("" === f.text().trim() && !g || "images" === g) ? (f.addClass("medium-insert-active"), "images" === g ? this.$el.find(".medium-insert-buttons").attr("data-active-addon", g) : this.$el.find(".medium-insert-buttons").removeAttr("data-active-addon"), setTimeout(function () {
            ...
            b.show(), b.find("li").show(), a && (b.find("li").hide(), b.find('button[data-addon="' + a + '"]').parent().show())
            ...
            var d = this.$el.find(".medium-insert-buttons"), e = this.$el.find(".medium-insert-active"), f = e.hasClass("medium-insert-images-grid") ? [] : e.find("figure:last figcaption"), g = this.getEditor() ? this.getEditor().options.elementsContainer : a("body").get(0), h = ["absolute", "fixed"].indexOf(b.getComputedStyle(g).getPropertyValue("position")) > -1, i = {};
            e.length && (i.left = e.position().left, i.top = e.position().top, c ? (i.left += e.width() - d.find(".medium-insert-buttons-show").width() - 10, i.top += e.height() - 20 + (f.length ? -f.height() - parseInt(f.css("margin-top"), 10) : 10)) : (i.left += -parseInt(d.find(".medium-insert-buttons-addons").css("left"), 10) - parseInt(d.find(".medium-insert-buttons-addons button:first").css("margin-left"), 10), i.top += parseInt(e.css("margin-top"), 10)), h && (i.top += g.scrollTop), this.$el.hasClass("medium-editor-placeholder") === !1 && i.left < 0 && (i.left = e.position().left), d.css(i))
        }, f.prototype.toggleAddons = function () {
            return "images" === this.$el.find(".medium-insert-buttons").attr("data-active-addon") ? void this.$el.find(".medium-insert-buttons").find('button[data-addon="images"]').click() : (this.$el.find(".medium-insert-buttons-addons").fadeToggle(), void this.$el.find(".medium-insert-buttons-show").toggleClass("medium-insert-buttons-rotate"))
            ...
            var c = a(b.currentTarget), d = c.data("addon"), f = c.data("action");
            ...
            0 === c.length && a.append(this.templates["src/js/templates/core-caption.hbs"]({placeholder: b}))
        ...
        var f = "mediumInsert", g = "Embeds", h = {
            ...
            actions: {
                remove: {
                    label: '<span class="fa fa-times"></span>', clicked: function () {
        ...
        e.prototype.init = function () {
            ...
            this.$el.find(".mediumInsert-embeds").removeClass("mediumInsert-embeds").addClass("medium-insert-embeds"), this.$el.find(".medium-insert-embeds").each(function () {
                0 === a(this).find(".medium-insert-embed").length && (a(this).after(b.templates["src/js/templates/embeds-wrapper.hbs"]({html: a(this).html()})), a(this).remove())
            })
            ...
            a.html(this.templates["src/js/templates/core-empty-line.hbs"]().trim()), a.is("p") && (a.replaceWith('<div class="medium-insert-active">' + a.html() + "</div>"), a = this.$el.find(".medium-insert-active"), this.core.moveCaret(a)), a.addClass("medium-insert-embeds medium-insert-embeds-input medium-insert-embeds-active"), this.togglePlaceholder({target: a.get(0)}), a.click(), this.core.hideButtons()
        }, e.prototype.togglePlaceholder = function (c) {
            var d, e, f, g = a(c.target), h = b.getSelection();
            ...
            a.support.cors = !0, a.ajax({
                ...
                success: function (b) {
                    var f = b && b.html;
                    return e.options.storeMeta && (f += '<div class="medium-insert-embeds-meta"><script type="text/json">' + JSON.stringify(b) + "</script></div>"), b && !f && "photo" === b.type && b.url && (f = '<img src="' + b.url + '" alt="">'), f ? void(d ? a.proxy(e, "embed", f, c)() : a.proxy(e, "embed", f)()) : void a.proxy(e, "convertBadEmbed", c)()
                },
            ...
            return b ? (b.indexOf("</script>") > -1 && (d = a("<div>").attr("data-embed-code", a("<div />").text(b).html()).html(b), b = a("<div>").append(d).html()), c ? (e = this.$el.find(":not(iframe, script, style)").contents().filter(function () {
                return 3 === this.nodeType && this.textContent.indexOf(c) > -1
            }).parent(), e.after(this.templates["src/js/templates/embeds-wrapper.hbs"]({html: b})), e.text(e.text().replace(c, ""))) : (e.after(this.templates["src/js/templates/embeds-wrapper.hbs"]({html: b})), e.remove()), this.core.triggerInput(), -1 !== b.indexOf("facebook") && "undefined" != typeof FB && setTimeout(function () {
                FB.XFBML.parse()
            ...
            var c = a(b.target).hasClass("medium-insert-embeds") ? a(b.target) : a(b.target).closest(".medium-insert-embeds"), d = this.$el.find(".medium-insert-embeds-selected");
            ...
            var b, c, d, e, f = this.$el.find(".medium-insert-embeds-selected"), g = !1;
            0 !== f.length && (d = this.core.getEditor(), e = d.options.elementsContainer || "body", a(e).append(this.templates["src/js/templates/embeds-toolbar.hbs"]({
                styles: this.options.styles,
                actions: this.options.actions
            }).trim()), b = a(".medium-insert-embeds-toolbar"), c = a(".medium-insert-embeds-toolbar2"), b.find("button").each(function () {
                f.hasClass("medium-insert-embeds-" + a(this).data("action")) && (a(this).addClass("medium-editor-button-active"), g = !0)
            }), g === !1 && b.find("button").first().addClass("medium-editor-button-active"), this.repositionToolbars(), b.fadeIn(), c.fadeIn())
            ...
            var c = a(".medium-insert-embeds-toolbar"), d = a(".medium-insert-embeds-toolbar2"), e = this.$el.find(".medium-insert-embeds-selected"), f = this.core.getEditor().options.elementsContainer, g = ["absolute", "fixed"].indexOf(b.getComputedStyle(f).getPropertyValue("position")) > -1, h = g ? f.getBoundingClientRect() : null, i = a(b).width(), j = {};
            d.length && (j.top = e.offset().top + 2, j.left = e.offset().left + e.width() - d.width() - 4, g && (j.top += f.scrollTop - h.top, j.left -= h.left, i = a(f).width()), j.left + d.width() > i && (j.left = i - d.width()), d.css(j)), c.length && (j.left = e.offset().left + e.width() / 2 - c.width() / 2, j.top = e.offset().top - c.height() - 8 - 2 - 5, g && (j.top += f.scrollTop - h.top, j.left -= h.left), j.top < 0 && (j.top = 0), c.css(j))
        }, e.prototype.toolbarAction = function (b) {
            var c = a(b.target).is("button") ? a(b.target) : a(b.target).closest("button"), d = c.closest("li"), e = d.closest("ul"), f = e.find("li"), g = this.$el.find(".medium-insert-embeds-selected"), h = this;
            ...
            var c = a(b.target).is("button") ? a(b.target) : a(b.target).closest("button"), d = this.options.actions[c.data("action")].clicked;
    ...
    }(jQuery, window, document), function (a, b, d, e, f) {
        "use strict";
        function g(c, d) {
        ...
        var h = "mediumInsert", i = "Images", j = {
            ...
            autoGrid: 3,
            fileUploadOptions: {url: null, acceptFileTypes: /(\.|\/)(gif|jpe?g|png)$/i},
            fileDeleteOptions: {},
            styles: {
                wide: {label: '<span class="fa fa-align-justify"></span>'},
                left: {label: '<span class="fa fa-align-left"></span>'},
        ...
        g.prototype.init = function () {
            ...
            a(d).on("click", a.proxy(this, "unselectImage")).on("keydown", a.proxy(this, "removeImage")).on("click", ".medium-insert-images-toolbar .medium-editor-action", a.proxy(this, "toolbarAction")).on("click", ".medium-insert-images-toolbar2 .medium-editor-action", a.proxy(this, "toolbar2Action")), this.$el.on("click", ".medium-insert-images img", a.proxy(this, "selectImage")), a(b).on("resize", a.proxy(this, "autoRepositionToolbars"))
            ...
            return a.each(b, function (c) {
                var d = a("<div />").html(b[c].value);
                d.find(".medium-insert-images").find("figcaption, figure").removeAttr("contenteditable"), d.find(".medium-insert-images-progress").remove(), b[c].value = d.html()
            }), b
        }, g.prototype.add = function () {
            var b = this, c = a(this.templates["src/js/templates/images-fileupload.hbs"]()), d = {
                dataType: "json",
                add: function (c, d) {
            ...
            var d, e = this.$el.find(".medium-insert-active"), f = this, g = [], h = c.files[0], i = this.options.fileUploadOptions.acceptFileTypes, j = this.options.fileUploadOptions.maxFileSize;
            ...
            var c = a(b.target), d = this.$el.find(".medium-insert-image-active");
            ...
            var f, g, h, i, j, k, l, m, n, o, p = [], q = this.$el.find(".medium-insert-image-active");
            if ((8 === e.which || 46 === e.which) && (q.length && p.push(q), h = b.getSelection(), h && h.rangeCount && (i = h.getRangeAt(0), j = i.commonAncestorContainer, l = "#text" === j.nodeName ? a(j).parent() : a(j), k = c.selection.getCaretOffsets(j).left, 8 === e.which && 0 === k ? m = l.prev() : 46 === e.which && k === l.text().length && (m = l.next()), m && m.hasClass("medium-insert-images") && p.push(m.find("img")), n = c.selection.getSelectionHtml(d), n && a("<div></div>").html(n).find(".medium-insert-images img").each(function () {
                p.push(a(this))
            })), p.length)) {
                for (o = 0; o < p.length; o++)this.deleteFile(p[o].attr("src")), f = p[o].closest(".medium-insert-images"), p[o].closest("figure").remove(), 0 === f.find("figure").length && (g = f.next(), (g.is("p") === !1 || "" !== g.text()) && (g = a(this.templates["src/js/templates/core-empty-line.hbs"]().trim()), f.before(g)), f.remove());
                this.core.hideAddons(), !n && g && (e.preventDefault(), this.core.moveCaret(g)), a(".medium-insert-images-toolbar, .medium-insert-images-toolbar2").remove(), this.core.triggerInput()
            }
        }, g.prototype.deleteFile = function (b) {
            ...
            var b, c, d = this.$el.find(".medium-insert-image-active"), e = d.closest(".medium-insert-images"), f = !1, g = this.core.getEditor(), h = g.options.elementsContainer || "body";
            a(h).append(this.templates["src/js/templates/images-toolbar.hbs"]({
                styles: this.options.styles,
                actions: this.options.actions
            }).trim()), b = a(".medium-insert-images-toolbar"), c = a(".medium-insert-images-toolbar2"), b.find("button").each(function () {
                e.hasClass("medium-insert-images-" + a(this).data("action")) && (a(this).addClass("medium-editor-button-active"), f = !0)
            }), f === !1 && b.find("button").first().addClass("medium-editor-button-active"), this.repositionToolbars(), b.fadeIn(), c.fadeIn()
        }, g.prototype.autoRepositionToolbars = function () {
            setTimeout(function () {
                this.repositionToolbars(), this.repositionToolbars()
            }.bind(this), 0)
        }, g.prototype.repositionToolbars = function () {
            var c = a(".medium-insert-images-toolbar"), d = a(".medium-insert-images-toolbar2"), e = this.$el.find(".medium-insert-image-active"), f = this.core.getEditor().options.elementsContainer, g = ["absolute", "fixed"].indexOf(b.getComputedStyle(f).getPropertyValue("position")) > -1, h = g ? f.getBoundingClientRect() : null, i = a(b).width(), j = {};
            ...
            return this.each(function () {
                a.data(this, "plugin_" + h + i) || a.data(this, "plugin_" + h + i, new g(this, b))
            })
        }
